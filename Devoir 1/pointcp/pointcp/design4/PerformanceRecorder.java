...
public class PerformanceRecorder{
  ...
  public static PointCP4 createRandomPoints(Random rd){
    char rdType = rd.nextBoolean() ? 'C' : 'P';
    double rdXOrRho = rd.nextDouble();
    double rdYOrTheta = rd.nextDouble();
    return new PointCP4(rdType, rdXOrRho, rdYOrTheta);
  }

  public static long runRecorder(Random rd, PointCP4 testPoint){
    long endTime;
    long startTime;
    long elapsedTime;
