...
public class PerformanceRecorder{
  ...
  public static PointCP3 createRandomPoints(Random rd){
    char rdType = rd.nextBoolean() ? 'C' : 'P';
    double rdXOrRho = rd.nextDouble();
    double rdYOrTheta = rd.nextDouble();
    return new PointCP3(rdType, rdXOrRho, rdYOrTheta);
  }

  public static long runRecorder(Random rd, PointCP3 testPoint){
    long endTime;
    long startTime;
    long elapsedTime;
